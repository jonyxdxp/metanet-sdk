// from https://github.com/cosmos/cosmos-sdk/blob/main/store/gaskv/store.go

// Package gaskv provides a gas-tracking wrapper around a KVStore. It implements the
// KVStore interface and charges gas for each operation based on the provided GasConfig.

// KVStore que aplica el gas metering
